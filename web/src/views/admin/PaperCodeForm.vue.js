...
var paperCodeId = (0, vue_1.computed)(function () { return Number(route.params.id) || null; });
...
var allExamNodes = (0, vue_1.ref)([]); // Store all exam nodes
...
var fetchExamNodes = function (syllabusId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_4 = _a.sent();
                console.error('Failed to fetch exam nodes:', error_4);
                allExamNodes.value = [];
                return [3 /*break*/, 4];
...
var fetchPaperCodeDetails = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var response, seriesData, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                return [4 /*yield*/, paperCodeService_1.default.getPaperCodeById(id)];
            case 1:
                response = _a.sent();
            ...
            case 2:
                ...
                _a.label = 3;
            case 3:
                if (!seriesData.syllabusId) return [3 /*break*/, 5];
                return [4 /*yield*/, fetchExamNodes(seriesData.syllabusId)];
            case 4:
                _a.sent();
                _a.label = 5;
            ...
            case 6:
                error_5 = _a.sent();
                console.error('Failed to fetch paper series details:', error_5);
...
var availableExamNodes = (0, vue_1.computed)(function () { return allExamNodes.value; });
...
(0, vue_1.watch)(function () { return form.value.syllabusId; }, function (newSyllabusId) {
    if (newSyllabusId) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                if (!(isEditMode.value && paperCodeId.value)) return [3 /*break*/, 3];
                return [4 /*yield*/, paperCodeService_1.default.updatePaperCode(__assign(__assign({}, payload), { id: paperCodeId.value }))];
            case 2:
                _c.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, paperCodeService_1.default.createPaperCode(payload)];
            case 4:
                _c.sent();
                _c.label = 5;
            case 5:
                router.push('/admin/paper-codes');
                return [3 /*break*/, 8];
            case 6:
                error_6 = _c.sent();
                console.error('Failed to submit paper series:', error_6);
                submitError.value = ((_b = (_a = error_6.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'An unexpected error occurred.';
                return [3 /*break*/, 8];
            case 7:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                if (!(isEditMode.value && paperCodeId.value)) return [3 /*break*/, 3];
                return [4 /*yield*/, fetchPaperCodeDetails(paperCodeId.value)];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [2 /*return*/];
...
(__VLS_ctx.isEditMode ? __VLS_ctx.$t('paperCode.edit') : __VLS_ctx.$t('paperCode.add'));
...
(__VLS_ctx.availableSyllabuses.length ? __VLS_ctx.$t('paperCode.selectSyllabus') : __VLS_ctx.$t('paperCode.noSyllabusMatch'));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "mb-6" }));
/** @type {__VLS_StyleScopedClasses['mb-6']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ class: "block text-gray-700 text-sm font-bold mb-2" }, { for: "examNode" }));
/** @type {__VLS_StyleScopedClasses['block']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-2']} */ ;
(__VLS_ctx.$t('paperCode.examNode'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ id: "examNode", value: (__VLS_ctx.form.examNodeId) }, { class: "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" }), { disabled: (!__VLS_ctx.availableExamNodes.length) }));
/** @type {__VLS_StyleScopedClasses['shadow']} */ ;
/** @type {__VLS_StyleScopedClasses['appearance-none']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded']} */ ;
...
(__VLS_ctx.$t('paperCode.noExamNode'));
for (var _f = 0, _g = __VLS_vFor((__VLS_ctx.availableExamNodes)); _f < _g.length; _f++) {
    var node = _g[_f][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (node.id),
        value: (node.id),
    ...
    (node.name);
    // @ts-ignore
    [$t, $t, form, errors, errors, availableExamNodes, availableExamNodes,];
}
...
routerLink;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ to: "/admin/paper-codes" }, { class: "inline-block align-baseline font-bold text-sm text-indigo-600 hover:text-indigo-800" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: "/admin/paper-codes" }, { class: "inline-block align-baseline font-bold text-sm text-indigo-600 hover:text-indigo-800" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
