...
var totalOrganisations = (0, vue_1.ref)(0);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, organisationService_1.default.getOrganisations({
...
var deleteOrganisation = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!confirm('Are you sure you want to delete this organisation? This action cannot be undone.')) return [3 /*break*/, 4];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, organisationService_1.default.deleteOrganisation(id)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_2 = _a.sent();
                console.error('Failed to delete organisation:', error_2);
                return [3 /*break*/, 4];
...
(__VLS_ctx.$t('organisationManagement.title'));
...
(__VLS_ctx.$t('organisationManagement.subtitle'));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign({ type: "text", value: (__VLS_ctx.searchQuery), placeholder: (__VLS_ctx.$t('organisationManagement.searchByName')) }, { class: "px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm w-full sm:w-auto" }));
...
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: "/admin/organisations/create" }, { class: "inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full sm:w-auto" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
...
(__VLS_ctx.$t('organisationManagement.addOrganisation'));
// @ts-ignore
[$t, $t, $t, $t, searchQuery,];
var __VLS_3;
...
(__VLS_ctx.$t('organisationManagement.actions'));
...
if (__VLS_ctx.loading) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ colspan: "3" }, { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center" }));
    /** @type {__VLS_StyleScopedClasses['px-6']} */ ;
    ...
    (__VLS_ctx.$t('organisationManagement.loading'));
}
else if (!__VLS_ctx.organisations || __VLS_ctx.organisations.length === 0) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ colspan: "3" }, { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center" }));
    /** @type {__VLS_StyleScopedClasses['px-6']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-4']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-center']} */ ;
    (__VLS_ctx.$t('organisationManagement.noData'));
}
var _loop_1 = function (org) {
    ...
    routerLink;
    // @ts-ignore
    var __VLS_7 = __VLS_asFunctionalComponent1(__VLS_6, new __VLS_6(__assign({ to: ("/admin/organisations/".concat(org.id, "/edit")) }, { class: "text-indigo-600 hover:text-indigo-900" })));
    var __VLS_8 = __VLS_7.apply(void 0, __spreadArray([__assign({ to: ("/admin/organisations/".concat(org.id, "/edit")) }, { class: "text-indigo-600 hover:text-indigo-900" })], __VLS_functionalComponentArgsRest(__VLS_7), false));
    /** @type {__VLS_StyleScopedClasses['text-indigo-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-indigo-900']} */ ;
    var __VLS_11 = __VLS_9.slots.default;
    (__VLS_ctx.$t('organisationManagement.edit'));
    // @ts-ignore
    [$t, $t, $t, $t, $t, loading, organisations, organisations, organisations,];
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.deleteOrganisation(org.id);
            // @ts-ignore
            [deleteOrganisation,];
        } }, { class: "text-red-600 hover:text-red-900" }));
    /** @type {__VLS_StyleScopedClasses['text-red-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-red-900']} */ ;
    (__VLS_ctx.$t('organisationManagement.delete'));
    // @ts-ignore
    [$t,];
};
var __VLS_9;
...
if (!__VLS_ctx.loading && __VLS_ctx.totalOrganisations > 0) {
    ...
    (__VLS_ctx.$t('organisationManagement.pageInfo', { from: (__VLS_ctx.currentPage - 1) * __VLS_ctx.pageSize + 1, to: Math.min(__VLS_ctx.currentPage * __VLS_ctx.pageSize, __VLS_ctx.totalOrganisations), total: __VLS_ctx.totalOrganisations }));
    if (__VLS_ctx.totalPages > 1) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
                ...
                // @ts-ignore
                [$t, loading, totalOrganisations, totalOrganisations, totalOrganisations, currentPage, currentPage, currentPage, pageSize, pageSize, totalPages, goToPage,];
        ...
        (__VLS_ctx.$t('organisationManagement.previous'));
        ...
        for (var _b = 0, _c = __VLS_vFor((__VLS_ctx.paginationRange)); _b < _c.length; _b++) {
            var pageNumber = _c[_b][0];
            _loop_2(pageNumber);
        }
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
                var _a = [];
        ...
        /** @type {__VLS_StyleScopedClasses['disabled:opacity-50']} */ ;
        /** @type {__VLS_StyleScopedClasses['disabled:cursor-not-allowed']} */ ;
        (__VLS_ctx.$t('organisationManagement.next'));
    }
}
// @ts-ignore
