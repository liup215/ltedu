...
(0, vue_1.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                if (!isEdit.value) return [3 /*break*/, 6];
                loading.value = true;
                _a.label = 2;
            case 2:
                _a.trys.push([2, 4, 5, 6]);
                return [4 /*yield*/, qualificationService_1.default.getQualificationById(Number(route.params.id))];
            case 3:
                response = _a.sent();
            ...
            case 4:
                error_2 = _a.sent();
                console.error('Failed to load qualification:', error_2);
                return [3 /*break*/, 6];
            case 5:
                loading.value = false;
                return [7 /*endfinally*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, qualificationService_1.default.updateQualification({
            ...
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, qualificationService_1.default.createQualification({
                    name: formData.value.name.trim(),
                    organisationId: Number(formData.value.organisationId),
                })];
            case 4:
            ...
            case 6:
                error_3 = _a.sent();
                console.error('Failed to save qualification:', error_3);
                return [3 /*break*/, 8];
            case 7:
                loading.value = false;
                return [7 /*endfinally*/];
...
(__VLS_ctx.isEdit ? __VLS_ctx.$t('qualificationForm.editTitle') : __VLS_ctx.$t('qualificationForm.createTitle'));
...
(__VLS_ctx.isEdit ? __VLS_ctx.$t('qualificationForm.editSubtitle') : __VLS_ctx.$t('qualificationForm.createSubtitle'));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ for: "organisationId" }, { class: "block text-sm font-medium text-gray-700" }));
/** @type {__VLS_StyleScopedClasses['block']} */ ;
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
(__VLS_ctx.$t('qualificationForm.organisation'));
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "mt-1" }));
/** @type {__VLS_StyleScopedClasses['mt-1']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ id: "organisationId", value: (__VLS_ctx.formData.organisationId) }, { class: "block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" }), { required: true }));
/** @type {__VLS_StyleScopedClasses['block']} */ ;
/** @type {__VLS_StyleScopedClasses['w-full']} */ ;
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
...
(__VLS_ctx.$t('qualificationForm.selectOrganisation'));
for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.organisations)); _i < _a.length; _i++) {
    ...
    (org.name);
    // @ts-ignore
    [isEdit, isEdit, $t, $t, $t, $t, $t, $t, $t, $t, handleSubmit, formData, formData, organisations,];
}
...
/** @type {__VLS_StyleScopedClasses['focus:ring-indigo-500']} */ ;
(__VLS_ctx.$t('qualificationForm.cancel'));
...
(__VLS_ctx.loading ? __VLS_ctx.$t('qualificationForm.saving') : __VLS_ctx.$t('qualificationForm.save'));
// @ts-ignore
[$t, $t, $t, goBack, loading, loading, loading,];
