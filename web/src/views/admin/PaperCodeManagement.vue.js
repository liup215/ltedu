...
var fetchPaperCodeList = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                // if (selectedOrganisationId.value) { // Removed: This parameter is not supported by PaperCodeQuery
                //   query.organisationId = selectedOrganisationId.value;
                // }
                // if (selectedQualificationId.value) { // Removed: This parameter is not supported by PaperCodeQuery
                //   query.qualificationId = selectedQualificationId.value;
                // }
                if (selectedSyllabusId.value) {
                    query.syllabusId = selectedSyllabusId.value;
                }
                if (searchQuery.value.trim()) { // Removed: This parameter is not supported by PaperCodeQuery
                    query.name = searchQuery.value.trim();
                }
                return [4 /*yield*/, paperCodeService_1.default.getPaperCodeList(query)];
            case 2:
                response = _a.sent();
                paperCode.value = response.data.list;
...
var goToCreatePage = function () {
    router.push('/admin/paper-code/create');
};
var deletePaperCode = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, paperCodeService_1.default.deletePaperCode(id)];
            case 2:
                _a.sent();
                if (paperCode.value.length === 1 && currentPage.value > 1) {
                    currentPage.value--;
                }
                fetchPaperCodeList();
                return [3 /*break*/, 4];
...
(0, vue_1.watch)(searchQuery, function () {
    ...
    searchDebounceTimer = window.setTimeout(function () {
        currentPage.value = 1;
        // Client-side filtering if API doesn't support name search for PaperCode
        // For now, we assume the API handles filtering or we re-fetch and rely on pagination
        // If the API doesn't support search by name for PaperCode, this will just reload the current view
        // based on dropdowns.
        // To implement client-side search on the current page's data:
        // 1. Fetch all data if feasible, or
        // 2. Filter the 'paperCode.value' array directly if API doesn't support search.
        // The current setup re-calls fetchPaperCodeList, which doesn't send 'name' in query.
        // This means the search input currently doesn't filter by name via API.
        // If client-side search is desired on the fetched page:
        // You would need a computed property that filters `paperCode.value` based on `searchQuery.value`.
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetchQualificationsForDropdown(newOrgId || undefined)
                    ...
                    // However, PaperCodeQuery only takes syllabusId. So dropdowns are for narrowing down syllabusId.
                ];
            case 1:
                _a.sent();
                // When Org changes, fetch syllabi for that org (or all if "All Orgs")
...
(0, vue_1.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, fetchPaperCodeList()
                    // Set loading to false after all initial data is fetched
                    // loading.value = false; // This was here, but fetchPaperCodeList has its own finally block.
...
(__VLS_ctx.$t('paperCode.subtitle') || '');
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign({ type: "text", value: (__VLS_ctx.searchQuery), placeholder: (__VLS_ctx.$t('paperCode.searchByName')) }, { class: "px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base w-full sm:w-auto" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-3']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
if (__VLS_ctx.loading) {
    ...
    (__VLS_ctx.$t('paperCode.loading'));
}
else if (!__VLS_ctx.paperCode.length) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ colspan: "6" }, { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center" }));
    /** @type {__VLS_StyleScopedClasses['px-6']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-4']} */ ;
...
var _loop_1 = function (series) {
    ...
    routerLink;
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ to: ("/admin/paper-code/".concat(series.id, "/edit")) }, { class: "text-indigo-600 hover:text-indigo-900" })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: ("/admin/paper-code/".concat(series.id, "/edit")) }, { class: "text-indigo-600 hover:text-indigo-900" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    /** @type {__VLS_StyleScopedClasses['text-indigo-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-indigo-900']} */ ;
    var __VLS_5 = __VLS_3.slots.default;
    (__VLS_ctx.$t('paperCode.edit'));
    // @ts-ignore
    [$t, $t, $t, $t, $t, $t, $t, $t, $t, $t, searchQuery, goToCreatePage, loading, paperCode, paperCode,];
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.deletePaperCode(series.id);
            // @ts-ignore
            [deletePaperCode,];
        } }, { class: "text-red-600 hover:text-red-900" }));
    /** @type {__VLS_StyleScopedClasses['text-red-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-red-900']} */ ;
    (__VLS_ctx.$t('paperCode.delete'));
    // @ts-ignore
    [$t,];
};
var __VLS_3;
for (var _m = 0, _o = __VLS_vFor((__VLS_ctx.paperCode)); _m < _o.length; _m++) {
    var series = _o[_m][0];
    _loop_1(series);
}
if (!__VLS_ctx.loading && __VLS_ctx.totalItems > 0) {
    ...
    (__VLS_ctx.$t('paperCode.pageInfo', { from: (__VLS_ctx.currentPage - 1) * __VLS_ctx.pageSize + 1, to: Math.min(__VLS_ctx.currentPage * __VLS_ctx.pageSize, __VLS_ctx.totalItems), total: __VLS_ctx.totalItems }));
