...
var totalSyllabuses = (0, vue_1.ref)(0);
...
var fetchSyllabuses = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to fetch syllabuses:', error_1);
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
                return [7 /*endfinally*/];
...
var fetchQualifications = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                console.error('Failed to fetch qualifications:', error_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); };
var deleteSyllabus = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!confirm('Are you sure you want to delete this syllabus? This action cannot be undone.')) return [3 /*break*/, 4];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, syllabusService_1.default.deleteSyllabus(id)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_4 = _a.sent();
                console.error('Failed to delete syllabus:', error_4);
                return [3 /*break*/, 4];
...
(0, vue_1.watch)([searchQuery, selectedOrganisationId, selectedQualificationId], function () {
...
(__VLS_ctx.$t('syllabusManagement.title'));
...
(__VLS_ctx.$t('syllabusManagement.subtitle'));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign({ type: "text", value: (__VLS_ctx.searchQuery), placeholder: (__VLS_ctx.$t('syllabusManagement.searchByNameOrCode')) }, { class: "px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base w-full sm:w-auto" }));
...
/** @type {__VLS_StyleScopedClasses['w-full']} */ ;
/** @type {__VLS_StyleScopedClasses['sm:w-auto']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign({ value: (__VLS_ctx.selectedOrganisationId) }, { class: "px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base w-full sm:w-auto" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-3']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
for (var _i = 0, _d = __VLS_vFor((__VLS_ctx.organisations)); _i < _d.length; _i++) {
    var org = _d[_i][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (org.id),
        value: (org.id),
...
for (var _e = 0, _f = __VLS_vFor((__VLS_ctx.filteredQualifications)); _e < _f.length; _e++) {
    var qual = _f[_e][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (qual.id),
        value: (qual.id),
    ...
    (qual.name);
    // @ts-ignore
    [$t, selectedOrganisationId, selectedQualificationId, filteredQualifications,];
}
var __VLS_0;
/** @ts-ignore @type {typeof __VLS_components.routerLink | typeof __VLS_components.RouterLink | typeof __VLS_components.routerLink | typeof __VLS_components.RouterLink} */
routerLink;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ to: "/admin/syllabuses/create" }, { class: "inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full sm:w-auto" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: "/admin/syllabuses/create" }, { class: "inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full sm:w-auto" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
...
/** @type {__VLS_StyleScopedClasses['uppercase']} */ ;
/** @type {__VLS_StyleScopedClasses['tracking-wider']} */ ;
(__VLS_ctx.$t('syllabusManagement.code'));
__VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)(__assign({ scope: "col" }, { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }));
/** @type {__VLS_StyleScopedClasses['px-6']} */ ;
/** @type {__VLS_StyleScopedClasses['py-3']} */ ;
/** @type {__VLS_StyleScopedClasses['text-left']} */ ;
...
/** @type {__VLS_StyleScopedClasses['uppercase']} */ ;
/** @type {__VLS_StyleScopedClasses['tracking-wider']} */ ;
(__VLS_ctx.$t('syllabusManagement.organisation'));
__VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)(__assign({ scope: "col" }, { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }));
/** @type {__VLS_StyleScopedClasses['px-6']} */ ;
/** @type {__VLS_StyleScopedClasses['py-3']} */ ;
/** @type {__VLS_StyleScopedClasses['text-left']} */ ;
...
/** @type {__VLS_StyleScopedClasses['uppercase']} */ ;
/** @type {__VLS_StyleScopedClasses['tracking-wider']} */ ;
(__VLS_ctx.$t('syllabusManagement.qualification'));
...
(__VLS_ctx.$t('syllabusManagement.actions'));
...
if (__VLS_ctx.loading) {
    ...
    (__VLS_ctx.$t('syllabusManagement.loading'));
}
else if (!__VLS_ctx.syllabuses || __VLS_ctx.syllabuses.length === 0) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ colspan: "6" }, { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center" }));
    /** @type {__VLS_StyleScopedClasses['px-6']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-4']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-center']} */ ;
    (__VLS_ctx.$t('syllabusManagement.noData'));
}
var _loop_1 = function (syllabus) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
        key: (syllabus.id),
    });
    ...
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
    (((_b = (_a = syllabus.qualification) === null || _a === void 0 ? void 0 : _a.organisation) === null || _b === void 0 ? void 0 : _b.name) || '-');
    __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ class: "px-6 py-4 whitespace-nowrap text-sm text-gray-900" }));
    /** @type {__VLS_StyleScopedClasses['px-6']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-4']} */ ;
    /** @type {__VLS_StyleScopedClasses['whitespace-nowrap']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
    (((_c = syllabus.qualification) === null || _c === void 0 ? void 0 : _c.name) || '-');
    ...
    routerLink;
    // @ts-ignore
    var __VLS_7 = __VLS_asFunctionalComponent1(__VLS_6, new __VLS_6(__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/chapters")) }, { class: "text-indigo-600 hover:text-indigo-900" })));
    var __VLS_8 = __VLS_7.apply(void 0, __spreadArray([__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/chapters")) }, { class: "text-indigo-600 hover:text-indigo-900" })], __VLS_functionalComponentArgsRest(__VLS_7), false));
    /** @type {__VLS_StyleScopedClasses['text-indigo-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-indigo-900']} */ ;
    var __VLS_11 = __VLS_9.slots.default;
    (__VLS_ctx.$t('syllabusManagement.manageChapters'));
    // @ts-ignore
    [$t, $t, $t, $t, $t, $t, $t, $t, loading, syllabuses, syllabuses, syllabuses,];
    var __VLS_12 = void 0;
    /** @ts-ignore @type {typeof __VLS_components.routerLink | typeof __VLS_components.RouterLink | typeof __VLS_components.routerLink | typeof __VLS_components.RouterLink} */
    routerLink;
    // @ts-ignore
    var __VLS_13 = __VLS_asFunctionalComponent1(__VLS_12, new __VLS_12(__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/exam-nodes")) }, { class: "text-orange-600 hover:text-orange-900" })));
    var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/exam-nodes")) }, { class: "text-orange-600 hover:text-orange-900" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
    ...
    routerLink;
    // @ts-ignore
    var __VLS_19 = __VLS_asFunctionalComponent1(__VLS_18, new __VLS_18(__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/knowledge-points")) }, { class: "text-purple-600 hover:text-purple-900" })));
    var __VLS_20 = __VLS_19.apply(void 0, __spreadArray([__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/knowledge-points")) }, { class: "text-purple-600 hover:text-purple-900" })], __VLS_functionalComponentArgsRest(__VLS_19), false));
    /** @type {__VLS_StyleScopedClasses['text-purple-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-purple-900']} */ ;
    var __VLS_23 = __VLS_21.slots.default;
    (__VLS_ctx.$t('syllabusManagement.knowledgePoints'));
    // @ts-ignore
    [$t,];
    var __VLS_24 = void 0;
    /** @ts-ignore @type {typeof __VLS_components.routerLink | typeof __VLS_components.RouterLink | typeof __VLS_components.routerLink | typeof __VLS_components.RouterLink} */
    routerLink;
    // @ts-ignore
    var __VLS_25 = __VLS_asFunctionalComponent1(__VLS_24, new __VLS_24(__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/edit")) }, { class: "text-indigo-600 hover:text-indigo-900" })));
    var __VLS_26 = __VLS_25.apply(void 0, __spreadArray([__assign({ to: ("/admin/syllabuses/".concat(syllabus.id, "/edit")) }, { class: "text-indigo-600 hover:text-indigo-900" })], __VLS_functionalComponentArgsRest(__VLS_25), false));
    /** @type {__VLS_StyleScopedClasses['text-indigo-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-indigo-900']} */ ;
    var __VLS_29 = __VLS_27.slots.default;
    (__VLS_ctx.$t('syllabusManagement.edit'));
    // @ts-ignore
    [$t,];
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.deleteSyllabus(syllabus.id);
            // @ts-ignore
            [deleteSyllabus,];
        } }, { class: "text-red-600 hover:text-red-900" }));
    /** @type {__VLS_StyleScopedClasses['text-red-600']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:text-red-900']} */ ;
    (__VLS_ctx.$t('syllabusManagement.delete'));
    // @ts-ignore
    [$t,];
};
var __VLS_9, __VLS_15, __VLS_21, __VLS_27;
for (var _g = 0, _h = __VLS_vFor((__VLS_ctx.syllabuses)); _g < _h.length; _g++) {
    var syllabus = _h[_g][0];
    _loop_1(syllabus);
}
if (!__VLS_ctx.loading && __VLS_ctx.totalSyllabuses > 0) {
    ...
    (__VLS_ctx.$t('syllabusManagement.pageInfo', { from: (__VLS_ctx.currentPage - 1) * __VLS_ctx.pageSize + 1, to: Math.min(__VLS_ctx.currentPage * __VLS_ctx.pageSize, __VLS_ctx.totalSyllabuses), total: __VLS_ctx.totalSyllabuses }));
    if (__VLS_ctx.totalPages > 1) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
                ...
                // @ts-ignore
                [$t, loading, totalSyllabuses, totalSyllabuses, totalSyllabuses, currentPage, currentPage, currentPage, pageSize, pageSize, totalPages, goToPage,];
        ...
        for (var _j = 0, _k = __VLS_vFor((__VLS_ctx.paginationRange)); _j < _k.length; _j++) {
            var pageNumber = _k[_j][0];
            _loop_2(pageNumber);
        }
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
                var _a = [];
