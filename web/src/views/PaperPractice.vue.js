...
var selectedPastPaperId = (0, vue_1.ref)('');
function fetchPastPapers() {
    ...
    pastPaperService_1.default.getPastPapers(query).then(function (res) {
        var _a;
        pastPapers.value = ((_a = res.data) === null || _a === void 0 ? void 0 : _a.list) || [];
    });
}
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, qualificationService_1.default.getQualifications({ organisationId: Number(selectedOrganisationId.value), pageIndex: 1, pageSize: 100 })];
            case 1:
                res = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, syllabusService_1.default.getSyllabuses({ qualificationId: Number(selectedQualificationId.value), pageIndex: 1, pageSize: 100 })];
            case 1:
                res = _b.sent();
...
var fetchYears = function () { return __awaiter(void 0, void 0, void 0, function () {
...
var fetchPaperCodes = function () { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, paperCodeService_1.default.getPaperCodeList({ syllabusId: Number(selectedSyllabusId.value), pageIndex: 1, pageSize: 100 })];
            case 1:
                res = _b.sent();
                paperCodes.value = ((_a = res.data) === null || _a === void 0 ? void 0 : _a.list) || [];
                return [2 /*return*/];
        }
    });
}); };
var fetchPaperSeries = function () { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, paperSeriesService_1.default.getPaperSeriesList({ syllabusId: Number(selectedSyllabusId.value), pageIndex: 1, pageSize: 100 })];
            case 1:
                res = _b.sent();
                paperSeriesList.value = ((_a = res.data) === null || _a === void 0 ? void 0 : _a.list) || [];
                return [2 /*return*/];
        }
    });
}); };
...
var startPractice = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!selectedPastPaperId.value)
                    return [2 /*return*/];
                return [4 /*yield*/, practiceService_1.practiceService.paperPractice({ paperId: Number(selectedPastPaperId.value) })];
            case 1:
                res = _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!id)
                    return [2 /*return*/];
                if (!!questions.value[id]) return [3 /*break*/, 2];
                return [4 /*yield*/, questionService_1.default.getQuestionById(id)];
            case 1:
                res = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, practiceService_1.practiceService.gradePractice(submissionAnswers)];
            case 1:
                res = _a.sent();
...
if (__VLS_ctx.questionIds.length > 0 && !__VLS_ctx.sidebarVisible) {
    ...
    (__VLS_ctx.$t('paperPractice.showSidebar'));
}
...
(__VLS_ctx.$t('paperPractice.title'));
...
(__VLS_ctx.$t('paperPractice.subtitle'));
...
(__VLS_ctx.$t('paperPractice.organisation'));
...
(__VLS_ctx.$t('paperPractice.selectOrganisation'));
...
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
(__VLS_ctx.$t('paperPractice.qualification'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ onChange: (__VLS_ctx.onQualificationChange) }, { value: (__VLS_ctx.selectedQualificationId), required: true }), { class: "px-3 py-2 border border-gray-300 rounded-md min-w-[180px] w-full" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
(__VLS_ctx.$t('paperPractice.selectQualification'));
...
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
(__VLS_ctx.$t('paperPractice.syllabus'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ onChange: (__VLS_ctx.onSyllabusChange) }, { value: (__VLS_ctx.selectedSyllabusId), required: true }), { class: "px-3 py-2 border border-gray-300 rounded-md min-w-[180px] w-full" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
(__VLS_ctx.$t('paperPractice.selectSyllabus'));
for (var _h = 0, _j = __VLS_vFor((__VLS_ctx.syllabuses)); _h < _j.length; _h++) {
    ...
    (syllabus.code);
    // @ts-ignore
    [$t, $t, onSyllabusChange, selectedSyllabusId, syllabuses,];
}
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-1" }));
/** @type {__VLS_StyleScopedClasses['block']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
(__VLS_ctx.$t('paperPractice.year'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ onChange: (__VLS_ctx.onYearChange) }, { value: (__VLS_ctx.year) }), { class: "px-3 py-2 border border-gray-300 rounded-md min-w-[120px] w-full" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
(__VLS_ctx.$t('paperPractice.selectYear'));
for (var _k = 0, _l = __VLS_vFor((__VLS_ctx.years)); _k < _l.length; _k++) {
    var y = _l[_k][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (y),
        value: (y),
...
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
(__VLS_ctx.$t('paperPractice.paperCode'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ onChange: (__VLS_ctx.onPaperCodeChange) }, { value: (__VLS_ctx.paperCode) }), { class: "px-3 py-2 border border-gray-300 rounded-md min-w-[120px] w-full" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
(__VLS_ctx.$t('paperPractice.selectPaperCode'));
for (var _m = 0, _o = __VLS_vFor((__VLS_ctx.paperCodes)); _m < _o.length; _m++) {
    var code = _o[_m][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (code.id),
        value: (code.id),
    ...
    (code.name);
    // @ts-ignore
    [$t, $t, onPaperCodeChange, paperCode, paperCodes,];
}
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-1" }));
/** @type {__VLS_StyleScopedClasses['block']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
(__VLS_ctx.$t('paperPractice.paperSeries'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ onChange: (__VLS_ctx.onPaperSeriesChange) }, { value: (__VLS_ctx.paperSeries) }), { class: "px-3 py-2 border border-gray-300 rounded-md min-w-[120px] w-full" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
(__VLS_ctx.$t('paperPractice.selectPaperSeries'));
for (var _p = 0, _q = __VLS_vFor((__VLS_ctx.paperSeriesList)); _p < _q.length; _p++) {
    var series = _q[_p][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (series.id),
        value: (series.id),
    ...
    (series.name);
    // @ts-ignore
    [$t, $t, onPaperSeriesChange, paperSeries, paperSeriesList,];
}
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-1" }));
/** @type {__VLS_StyleScopedClasses['block']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
(__VLS_ctx.$t('paperPractice.pastPaper'));
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign({ value: (__VLS_ctx.selectedPastPaperId) }, { class: "px-3 py-2 border border-gray-300 rounded-md min-w-[180px] w-full" }));
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
/** @type {__VLS_StyleScopedClasses['py-2']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-gray-300']} */ ;
...
(__VLS_ctx.$t('paperPractice.selectPastPaper'));
for (var _r = 0, _s = __VLS_vFor((__VLS_ctx.pastPapers)); _r < _s.length; _r++) {
    var paper = _s[_r][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.option, __VLS_intrinsics.option)({
        key: (paper.id),
        value: (paper.id),
    ...
    (paper.year);
    // @ts-ignore
    [$t, $t, selectedPastPaperId, pastPapers,];
}
...
(__VLS_ctx.$t('paperPractice.start'));
...
(__VLS_ctx.$t('paperPractice.reset'));
if (__VLS_ctx.questionIds.length > 0) {
        ...
        if (__VLS_ctx.currentQuestionContents.length > 0) {
            ...
            var _loop_1 = function (content, cidx) {
                ...
                if (content.questionTypeId === __VLS_ctx.QUESTION_TYPE_SINGLE_CHOICE) {
                    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
                    for (var _z = 0, _0 = __VLS_vFor(((_a = content.singleChoice) === null || _a === void 0 ? void 0 : _a.options)); _z < _0.length; _z++) {
                        var opt = _0[_z][0];
                        ...
                        // @ts-ignore
                        [questionIds, questionIds, questionIds, questionIds, questions, currentIndex, currentIndex, currentIndex, currentIndex, answers, $t, $t, resetAll, submitAnswers, currentQuestion, currentQuestionContents, currentQuestionContents, question_model_1.QUESTION_TYPE_NAMES, question_model_1.QUESTION_TYPE_NAMES, question_model_1.QUESTION_TYPE_SINGLE_CHOICE,];
                    }
                }
                else if (content.questionTypeId === __VLS_ctx.QUESTION_TYPE_MULTIPLE_CHOICE) {
                    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
                    for (var _1 = 0, _2 = __VLS_vFor(((_b = content.multipleChoice) === null || _b === void 0 ? void 0 : _b.options)); _1 < _2.length; _1++) {
                        var opt = _2[_1][0];
                        __VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ key: (opt.prefix) }, { class: "block" }));
                        /** @type {__VLS_StyleScopedClasses['block']} */ ;
                        __VLS_asFunctionalElement1(__VLS_intrinsics.input)({
                    ...
                    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
                    var __VLS_10 = index_vue_1.default;
                    // @ts-ignore
                    var __VLS_11 = __VLS_asFunctionalComponent1(__VLS_10, new __VLS_10(__assign({ 'onUpdate:modelValue': {} }, { modelValue: ((_c = __VLS_ctx.answers[__VLS_ctx.questionIds[__VLS_ctx.currentIndex] + '-' + cidx]) !== null && _c !== void 0 ? _c : ''), readOnly: (false), height: "120px", placeholder: ('Your answer') })));
                    var __VLS_12 = __VLS_11.apply(void 0, __spreadArray([__assign({ 'onUpdate:modelValue': {} }, { modelValue: ((_d = __VLS_ctx.answers[__VLS_ctx.questionIds[__VLS_ctx.currentIndex] + '-' + cidx]) !== null && _d !== void 0 ? _d : ''), readOnly: (false), height: "120px", placeholder: ('Your answer') })], __VLS_functionalComponentArgsRest(__VLS_11), false));
                    var __VLS_15 = void 0;
            ...
            for (var _t = 0, _u = __VLS_vFor((__VLS_ctx.currentQuestionContents)); _t < _u.length; _t++) {
                var _v = _u[_t], content = _v[0], cidx = _v[1];
    ...
    /** @type {__VLS_StyleScopedClasses['rounded']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:bg-gray-300']} */ ;
    (__VLS_ctx.$t('paperPractice.previous'));
    ...
    /** @type {__VLS_StyleScopedClasses['rounded']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:bg-gray-300']} */ ;
    (__VLS_ctx.$t('paperPractice.next'));
    ...
    (__VLS_ctx.$t('paperPractice.submitAnswers'));
}
if (__VLS_ctx.result && __VLS_ctx.questionIds.length > 0) {
    ...
    if (__VLS_ctx.resultItem) {
        ...
        /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
        (__VLS_ctx.currentIndex + 1);
        for (var _w = 0, _x = __VLS_vFor((__VLS_ctx.resultItem.subResults)); _w < _x.length; _w++) {
            var _y = _x[_w], sub = _y[0], pidx = _y[1];
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ key: (pidx) }, { class: "ml-4 mb-2" }));
            /** @type {__VLS_StyleScopedClasses['ml-4']} */ ;
            /** @type {__VLS_StyleScopedClasses['mb-2']} */ ;
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
            (__VLS_ctx.$t('paperPractice.part'));
            (pidx + 1);
            if (sub.questionType === __VLS_ctx.QUESTION_TYPE_SHORT_ANSWER) {
                ...
                /** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
                (__VLS_ctx.$t('paperPractice.yourAnswer'));
                var __VLS_17 = index_vue_1.default;
                // @ts-ignore
                ...
                if (sub.correctAnswer) {
                    ...
                    (__VLS_ctx.$t('paperPractice.correctAnswer'));
                }
                if (sub.correctAnswer) {
                    var __VLS_22 = index_vue_1.default;
                    // @ts-ignore
                ...
                if (sub.modelAnswer) {
                    ...
                    /** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
                    /** @type {__VLS_StyleScopedClasses['mt-2']} */ ;
                    (__VLS_ctx.$t('paperPractice.modelAnswer'));
                }
                if (sub.modelAnswer) {
                    var __VLS_27 = index_vue_1.default;
                    // @ts-ignore
                ...
                if (sub.isCorrect === true) {
                    ...
                    (__VLS_ctx.$t('paperPractice.correct'));
                }
