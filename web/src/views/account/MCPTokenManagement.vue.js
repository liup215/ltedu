...
var mcpEndpoint = (0, vue_1.ref)('');
var newToken = (0, vue_1.ref)({
    name: '',
    expiresAt: undefined
});
...
(0, vue_1.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, config_1.API_BASE_URL)()];
            case 1:
                baseUrl = _a.sent();
                mcpEndpoint.value = "".concat(baseUrl, "/api/mcp?token=YOUR_TOKEN");
                loadTokens();
                return [2 /*return*/];
        }
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, mcpTokenService_1.default.listTokens({
...
function createToken() {
    return __awaiter(this, void 0, void 0, function () {
        var data, date, response, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loading.value = true;
                ...
                case 1:
                    ...
                    if (newToken.value.expiresAt) {
                        date = new Date(newToken.value.expiresAt);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, 7, 8]);
                    return [4 /*yield*/, mcpTokenService_1.default.deleteToken(deleteConfirmation.value.tokenId)];
                case 2:
                    response = _a.sent();
                    if (!(response.code === 0)) return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, 7, 8]);
                    return [4 /*yield*/, mcpTokenService_1.default.deactivateToken(tokenId)];
                case 2:
                    response = _a.sent();
                    if (!(response.code === 0)) return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, 7, 8]);
                    return [4 /*yield*/, mcpTokenService_1.default.activateToken(tokenId)];
                case 2:
                    response = _a.sent();
                    if (!(response.code === 0)) return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, navigator.clipboard.writeText(mcpEndpoint.value)];
                case 1:
                    _a.sent();
                    (0, notification_1.showSuccess)('MCP Endpoint copied to clipboard');
                    return [3 /*break*/, 3];
                case 2:
                    error_7 = _a.sent();
                    (0, notification_1.showError)('Failed to copy endpoint');
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
...
function copyFullMcpUrl(token) {
    return __awaiter(this, void 0, void 0, function () {
        var baseUrl, fullUrl, error_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    baseUrl = _a.sent();
                    fullUrl = "".concat(baseUrl, "/api/mcp?token=").concat(token);
                    return [4 /*yield*/, navigator.clipboard.writeText(fullUrl)];
                case 2:
                    _a.sent();
                    (0, notification_1.showSuccess)('Full MCP URL copied to clipboard');
                    return [3 /*break*/, 4];
                case 3:
                    error_8 = _a.sent();
                    (0, notification_1.showError)('Failed to copy URL');
                    return [3 /*break*/, 4];
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6" }));
...
/** @type {__VLS_StyleScopedClasses['mb-6']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.h3, __VLS_intrinsics.h3)(__assign({ class: "text-sm font-medium text-blue-800 mb-2" }));
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.code, __VLS_intrinsics.code)(__assign({ class: "flex-1 bg-white px-3 py-2 rounded border border-blue-200 text-sm font-mono text-gray-800 break-all" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "mt-2 text-xs text-blue-600" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign({ value: (__VLS_ctx.newToken.name), type: "text", id: "tokenName", required: true, placeholder: "e.g., My Development Token" }, { class: "mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" }));
/** @type {__VLS_StyleScopedClasses['mt-1']} */ ;
/** @type {__VLS_StyleScopedClasses['block']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ type: "submit", disabled: (__VLS_ctx.loading || !__VLS_ctx.newToken.name) }, { class: "inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed" }));
/** @type {__VLS_StyleScopedClasses['inline-flex']} */ ;
/** @type {__VLS_StyleScopedClasses['items-center']} */ ;
...
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: (__VLS_ctx.loadTokens) }, { class: "inline-flex items-center px-3 py-1 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" }));
/** @type {__VLS_StyleScopedClasses['inline-flex']} */ ;
/** @type {__VLS_StyleScopedClasses['items-center']} */ ;
/** @type {__VLS_StyleScopedClasses['px-3']} */ ;
...
var _loop_1 = function (token) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: function () {
            ...
            // @ts-ignore
            [mcpEndpoint, copyMcpEndpoint, createToken, newToken, newToken, newToken, loading, loading, loadTokens, tokens, tokens, tokens, showFullToken, maskToken, toggleTokenVisibility,];
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.copyFullMcpUrl(token.token);
            // @ts-ignore
            [copyFullMcpUrl,];
