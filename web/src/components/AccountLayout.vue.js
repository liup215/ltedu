...
var AccountSidebar_vue_1 = require("./AccountSidebar.vue");
var sidebarOpen = (0, vue_1.ref)(false);
var __VLS_ctx = __assign(__assign({}, {}), {});
var __VLS_components;
var __VLS_intrinsics;
var __VLS_directives;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "flex flex-col min-h-screen bg-white" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
    ...
    } }, { class: "md:hidden fixed bottom-4 right-4 z-50 w-14 h-14 bg-indigo-600 text-white rounded-full shadow-lg flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" }), { 'aria-label': "Toggle account menu" }));
...
var __VLS_5 = AccountSidebar_vue_1.default;
// @ts-ignore
...
var __VLS_8;
var __VLS_9;
__VLS_asFunctionalElement1(__VLS_intrinsics.main, __VLS_intrinsics.main)(__assign({ class: "flex-1 p-4 md:p-6 bg-gray-100 min-w-0" }));
/** @type {__VLS_StyleScopedClasses['flex-1']} */ ;
