    ...
    },
    {
        ...
        children: [
            ...
            // Blog routes (public)
            {
                path: '/blog',
                name: 'Blog',
                component: function () { return Promise.resolve().then(function () { return require('../views/Blog.vue'); }); }
            },
            {
                path: '/blog/:slug',
                name: 'BlogPost',
                component: function () { return Promise.resolve().then(function () { return require('../views/BlogPost.vue'); }); }
            },
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                publicRouteNames = ['Login', 'Register', 'Setup', 'Home', 'QuickPractice', 'PaperPractice', 'Donation', 'ExamPaperBuilder', 'Blog', 'BlogPost', 'Help'];
