        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.post("".concat(this.baseUrl, "/create"), question)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.post("".concat(this.baseUrl, "/edit"), question)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
